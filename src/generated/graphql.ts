...
export type AllAuthorsQuery = { __typename?: "Query" } & Pick<
  Query,
  "countAuthors"
> & {
    authors: Array<
...
> & {
    books: Array<
      { __typename?: "Book" } & Pick<Book, "id" | "title"> & {
...
export type AuthorDetailsQuery = { __typename?: "Query" } & {
  author?: Maybe<
...
export type BookDetailsQuery = { __typename?: "Query" } & {
  book?: Maybe<
...
export const AllAuthorsDocument: DocumentNode<
  AllAuthorsQuery,
  ...
  definitions: [
    {
      ...
      selectionSet: {
        ...
        selections: [
          ...
          { kind: "Field", name: { kind: "Name", value: "countAuthors" } },
        ],
      },
    },
  ],
...
export const AuthorDetailsDocument: DocumentNode<
  AuthorDetailsQuery,
...
export const BookDetailsDocument: DocumentNode<
  BookDetailsQuery,
  ...
  definitions: [
    {
      kind: "OperationDefinition",
      operation: "query",
      name: { kind: "Name", value: "bookDetails" },
      variableDefinitions: [
        {
          kind: "VariableDefinition",
          variable: { kind: "Variable", name: { kind: "Name", value: "id" } },
